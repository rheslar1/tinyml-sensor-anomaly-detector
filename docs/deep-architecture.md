# TinyML Sensor Anomaly Detector Deep Architecture
...
C++17, C++ Design Patterns, SOLID, Cortex-M, TensorFlow Lite Micro, Quantization, CMSIS-NN, Ring buffers, Edge inference
