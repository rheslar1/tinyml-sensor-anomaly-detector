...
| --- | --- | --- |
| FR-001 | Provide a deterministic host-buildable runtime for TinyML Sensor Anomaly Detector. | CMake/CTest or equivalent CI. |
| FR-002 | Implement the project focus: Quantized sensor anomaly model running on an ARM Cortex-M core with measured RAM, flash, latency, and power budget constraints. | Scenario tests and documentation review. |
