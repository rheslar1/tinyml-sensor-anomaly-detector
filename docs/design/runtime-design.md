# TinyML Sensor Anomaly Detector Runtime Design
...
1. Build a runtime profile for `tinyml-sensor-anomaly-detector`.
...
The runtime must make this focus measurable through logs, reports, tests, diagrams, or hardware captures. The proof point for review is: Embedded ML optimization, memory budgeting, fixed-point inference, and useful intelligence at the device edge.
